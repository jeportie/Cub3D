...
/*   Updated: 2025/02/10 21:29:03 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_game_api		base;
	int				(*init)(struct s_texture_manager *self);
	int				(*run)(struct s_texture_manager *self);
	int				(*destroy)(struct s_texture_manager *self);

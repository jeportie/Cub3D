...
/*   Updated: 2025/02/15 10:25:50 by jeportie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define DEB_SET_CREATE		"[Settings Debug]\t\tFunction: create_settings() called!\n"
# define DEB_SET_INIT		"[Settings Debug]\t\tFunction: init_settings() called!\n"
# define DEB_SET_DESTROY	"[Settings Debug]\t\tFunction: destroy_settings() called!\n"
...
# define DEB_MAP_DESTROY	"[Map Debug]\t\tFunction: destroy_map() called!\n"
